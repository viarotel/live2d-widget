...
```xml
<script src="https://fastly.jsdelivr.net/gh/viarotel/live2d-widget@latest/autoload.js"></script>
```
...
| 选项 | 类型 | 默认值 | 说明 |
| - | - | - | - |
| `waifuPath` | `string` | `https://fastly.jsdelivr.net/gh/viarotel/live2d-widget@latest/waifu-tips.json` | 看板娘资源路径，可自行修改 |
...
```bash
git clone https://github.com/viarotel/live2d-widget.git
npm install
npm run build
```
