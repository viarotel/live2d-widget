...
```xml
<script src="https://fastly.jsdelivr.net/gh/viarotel/live2d-widget@master/autoload.js"></script>
```
...
| 选项 | 类型 | 默认值 | 说明 |
| - | - | - | - |
| `waifuPath` | `string` | `https://fastly.jsdelivr.net/gh/viarotel/live2d-widget@master/waifu-tips.json` | 看板娘资源路径，可自行修改 |
